    ...
    <form class="md:w-1/2 space-y-5" wire:submit.prevent='editarVacante'>
        ...
        <div>
            ...
            <select 
                ...
                id="categoria" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 w-full">
                <option>-- Seleccione --</option>
        ...
        <div>
           ...
           <textarea wire:model="descripcion" id="descripcion" cols="30" rows="10" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 w-full">
           </textarea>
        ...
        <div>
            <x-input-label for="imagen" :value="__('Imagen_nueva')" />
