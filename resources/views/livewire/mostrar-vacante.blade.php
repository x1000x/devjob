<div class="p-10">
  <div class="mb-5">
    ...
    <div class="bg-gray-50 p-4 my-10">
  ...
  @guest
    <div class="mt-5 bg-gray-50 border border-dashed p-5 text-center"> 
      <p>¿Deseas postular a esta vacante?
        <a class="font-bold text-indigo-600 " href="{{route('register')}}"> Crea una cuenta y postula a esta y otras vacantes</a>
      </p>
    </div>
  @endguest
@auth
